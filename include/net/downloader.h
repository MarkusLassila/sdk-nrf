...
enum downloader_evt_id {
	 ...
	 * @c downloader_host_cfg.keep_connection flag in
...
struct downloader {
	...
	struct downloader_host_cfg host_config;
 ...
 * @param[in] config	Downloader configuration options.
 *
 * @return Zero on success, otherwise a negative error code.
 */
int downloader_init(struct downloader *dl, struct downloader_cfg *config);
 ...
 *
 * @param[in] dl		Downloader instance.
 * @param[in] host_config	Host configuration options.
 * @param[in] url		URI of the host to connect to.
 ...
 * the server. Else the downloader is disconnected and the @c DOWNLOADER_EVT_STOPPED event is sent.
 *
 * @param[in] dl Downloader instance.
 *
 * @return Zero on success, a negative error code otherwise.
